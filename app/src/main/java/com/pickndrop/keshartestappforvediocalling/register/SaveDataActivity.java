...
public class SaveDataActivity extends AppCompatActivity {
    ...
    private void saveUserData() {
        ...
        if (imageUri == null) {
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).hasChild("image")) {
                        ...
                        Toast.makeText(SaveDataActivity.this, "Please select Image First!", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(SaveDataActivity.this, "Username should not be empty!", Toast.LENGTH_SHORT).show();
            progressDialog.dismiss();
        } else if (userStatus.equals("")) {
            Log.d(TAG, "saveUserData: userstatus null");
            Toast.makeText(SaveDataActivity.this, "User status should not be empty!", Toast.LENGTH_SHORT).show();
            progressDialog.dismiss();
        } else {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            finish();
                                            progressDialog.dismiss();
                                            Toast.makeText(SaveDataActivity.this, "Profile Settings has been updated!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
    ...
    private void saveInfoOnlyWithoutImage(String username, String userStatus) {
        progressDialog = new ProgressDialog(SaveDataActivity.this);
        progressDialog.setTitle("Account Settings");
        progressDialog.setMessage("Please Wait...");
        progressDialog.show();
        if (!username.equals("") && !userStatus.equals("")) {
            ...
            progressDialog.dismiss();
            Toast.makeText(SaveDataActivity.this, "Username and user status should not be empty!", Toast.LENGTH_SHORT).show();
        }
